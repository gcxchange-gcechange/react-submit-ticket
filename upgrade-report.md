# Upgrade project gcx-submit-ticket-client-side-solution to v1.17.4
...
File: [src\webparts\submitTicket\components\SubmitTicket.module.scss](src\webparts\submitTicket\components\SubmitTicket.module.scss)
...
```json
{
  "solution": {
    "metadata": {
      "shortDescription": {
        "default": "gcx-submit-ticket description"
      },
      "longDescription": {
        "default": "gcx-submit-ticket description"
      },
...
```json
{
  "solution": {
    "features": [
      {
        "title": "gcx-submit-ticket SubmitTicketWebPart Feature",
        "description": "The feature that activates SubmitTicketWebPart from the gcx-submit-ticket solution.",
        "id": "049f8f9f-6105-4790-8956-c7dc19c241f3",
        "version": "1.0.0.0",
        "componentIds": [
          "049f8f9f-6105-4790-8956-c7dc19c241f3"
        ]
      }
    ]
  }
...
#### [src\webparts\submitTicket\components\SubmitTicket.module.scss](src\webparts\submitTicket\components\SubmitTicket.module.scss)
